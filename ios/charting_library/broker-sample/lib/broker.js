 ...
 */
import { accountSummaryColumns, ordersPageColumns, positionsPageColumns, historyPageColumns, } from "./columns.js";
import { makeApiRequest, makeCRMApiRequest, makePostApiRequest, } from "./helpers.js";
    ...
    async placeOrder(preOrder) {
        ...
        try {
            ...
            if (response && response.success) {
                ...
                if (preOrder.takeProfit !== undefined ||
                    preOrder.stopLoss !== undefined) {
                    const orders = this._createOrderWithBrackets(responseData);
